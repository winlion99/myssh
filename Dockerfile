...
RUN a2enmod  rewrite
RUN wget https://github.com/winlion99/myssh/blob/main/000-default.conf
RUN rm /etc/apache2/sites-available/000-default.conf
RUN mv 000-default.conf /etc/apache2/sites-available
RUN echo 'You can play the awesome Cloud NOW! - Message from lUOLUO!' >/var/www/html/index.html
...
RUN echo root:Wang666|chpasswd
